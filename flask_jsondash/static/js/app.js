...
var jsondash = function() {
    ...
    function Widget(container, config) {
        ...
        self._makeWidget = function(config) {
            ...
            return d3.select(self.container).select('div')
                ...
                .attr('data-content', config.content)
    ...
    function populateEditForm(e) {
        ...
        $.each(conf, function(field, val){
            if(field === 'override' || field === 'refresh' || field === 'dynamic') {
    ...
    function getParsedFormConfig() {
        ...
        var conf = {
            ...
            dynamic: form.find('[name="dynamic"]').is(':checked'),
    ...
    function getHandler(family) {
        var handlers  = {
            ...
            echarts        : jsondash.handlers.handleEcharts,
            d3force        : jsondash.handlers.handleD3force,
            force2d        : jsondash.handlers.handleForce2d,
